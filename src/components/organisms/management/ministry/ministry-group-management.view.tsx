...
import MinistryGroupSideBar from '@/components/molecules/management/ministry/list/ministry-group-side-bar';
import MinistryGroupInformation from '@/components/molecules/management/ministry/informaton/ministry-group-information';
