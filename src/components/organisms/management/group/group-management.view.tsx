...
import GroupSideBar from '@/components/molecules/management/group/list/group-side-bar';
import GroupInformation from '@/components/molecules/management/group/informaton/group-information';
