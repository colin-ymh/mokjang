...
import EducationList from '@/components/molecules/setting/education/education-list';
...
type EducationSettingViewProps = {
...
const EducationSettingView = ({
  ...
  onClickHeaderBar,
}: EducationSettingViewProps) => {
  const t = useI18n();
  return (
    <EducationSettingContainer>
      {/* 교육 목록 */}
      ...
      <EducationInformationContainer $isEducation={!!selectedEducation.id}>
        ...
        {/* 컨텐츠 */}
        {getEducationSettingContent(headerBarId, selectedEducation)}
      </EducationInformationContainer>
    </EducationSettingContainer>
  );
};

export default EducationSettingView;
