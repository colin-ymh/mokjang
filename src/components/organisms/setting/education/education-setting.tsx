...
import EducationSettingView from '@/components/organisms/setting/education/education-setting.view';
...
import { useEducationSettingHeaderBarItems } from '@/hooks/layout/header-bar-items';

type EducationSettingProps = {};
...
const EducationSetting = ({}: EducationSettingProps) => {
  ...
  // 교육 설정 탭 헤더
  const headerBarItems = useEducationSettingHeaderBarItems();
