...
import EditMemberView from '@/components/organisms/member/edit/edit-member.view';
...
const EditMember = ({ onChangeProfileImage }: EditMemberProps) => {
  ...
  const [headerBarId, setHeaderBarId] = useState<EDIT_MEMBER_HEADER_ID>(
    EDIT_MEMBER_HEADER_ID.BASIC_INFORMATION
  );

  const onChangeHeader = (id: EDIT_MEMBER_HEADER_ID) => {
    setHeaderBarId(id);
  };
