...
import { StatusDropdownValueType } from '@/components/atoms/common/dropdown/status-dropdown-item';
import StatusDropdownView from '@/components/atoms/common/dropdown/status-dropdown.view';
...
const StatusDropdown = forwardRef<HTMLInputElement, DropdownProps>(
  (
    {
      items,
      value,
