...
import TermTableView from '@/components/molecules/setting/education/term-table.view';
import {
...
import TermInformation from '@/components/molecules/setting/education/term-information';
