import GroupHistoryListView from '@/components/molecules/member/information/history/group/group-history-list.view';
...
import EditGroupHistory from '@/components/molecules/member/information/history/group/edit-group-history';
