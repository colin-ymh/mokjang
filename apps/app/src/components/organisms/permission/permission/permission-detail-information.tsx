...
import PermissionDetailInformationView from '@/components/organisms/permission/permission/permission-detail-information.view';
...
const PermissionDetailInformation = ({
  ...
  return (
    <>
      <PermissionDetailInformationView {...props} />
